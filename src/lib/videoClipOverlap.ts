import type { TimelineVideoClip } from '@common/models';

/** Split video clips that overlap [cutStart, cutEnd) on the timeline (overwrite mode). */
export function cutTimelineRangeFromVideoClips(
